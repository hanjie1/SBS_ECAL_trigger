...
$(ObjDir)/ecal_cosmic_hls_tb.cpp_pre.cpp.tb.o : ecal_cosmic_hls_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ecal_cosmic_hls_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ecal_cosmic_hls.cpp_pre.cpp.tb.o : ecal_cosmic_hls.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ecal_cosmic_hls.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
