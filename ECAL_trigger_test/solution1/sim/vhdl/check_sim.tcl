...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ecal_cosmic_hls.autotvin_hit_width.dat"
         "c.ecal_cosmic_hls.autotvin_row_threshold.dat"
         "c.ecal_cosmic_hls.autotvin_s_fadc_hits_vxs.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ecal_cosmic_hls.autotvout_s_trigger_t.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
