...
if {[file isfile ecal_cosmic_hls.autotvin.dat]} {
	file delete -force ecal_cosmic_hls.autotvin.dat
}

if {[file isfile ecal_cosmic_hls.autotvout.dat]} {
	file delete -force ecal_cosmic_hls.autotvout.dat
}
