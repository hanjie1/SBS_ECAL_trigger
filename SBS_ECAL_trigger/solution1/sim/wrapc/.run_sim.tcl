...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /daqfs/Xilinx/Vitis_HLS/2023.2/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /daqfs/Xilinx/Vitis_HLS/2023.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /daqfs/Xilinx/Vitis_HLS/2023.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /daqfs/Xilinx/Vitis_HLS/2023.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ecal_cosmic_hls.autotvin.dat"
	set constFileTvOut       "ecal_cosmic_hls.autotvout.dat"
	set constFileHdlTvIn     "ecal_cosmic_hls.autohdltvin.dat"
	set constFileHdlTvOut    "ecal_cosmic_hls.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
