...
struct __cosim_T_27__ {char data[27];};
extern "C" void fpga_fifo_push_27(__cosim_T_27__* val, hls::stream<__cosim_T_27__>* fifo) {
  fifo->write(*val);
}
extern "C" void fpga_fifo_pop_27(__cosim_T_27__* val, hls::stream<__cosim_T_27__>* fifo) {
  *val = fifo->read();
}
extern "C" bool fpga_fifo_not_empty_27(hls::stream<__cosim_T_27__>* fifo) {
  return !fifo->empty();
}
extern "C" bool fpga_fifo_exist_27(hls::stream<__cosim_T_27__>* fifo) {
  return fifo->exist();
}
