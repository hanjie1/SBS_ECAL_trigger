...
{
#line 8 "/daqfs/home/hanjie/Desktop/GEp/SBS_ECAL_trigger/SBS_ECAL_trigger/allcrates/allcrates_script.tcl"
...
#pragma HLS PIPELINE II=1 style=flp
 ...
 fadc_hits_vxs fadc_hits = s_fadc_hits_vxs.read();
  ...
  int ch=0;
  int dt=0;
  VITIS_LOOP_56_1: for(ch=0; ch<216; ch++){
  ...
  VITIS_LOOP_68_3: for(dt=0; dt<8; dt++){
     VITIS_LOOP_69_4: for(ch=0; ch<216; ch++){
...
# 96 "ecal_cosmic_hls.cpp"
  ...
  VITIS_LOOP_111_5: for(ch=0; ch<216; ch++)
